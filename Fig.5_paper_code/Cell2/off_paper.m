...
path=('I:\soret_paper\timelapse\Cell2\time1\');
path_bg=('I:\soret_paper\timelapse\Cell2\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=172; ycenter=190; zcenter=27;
...
cell_off_zint=cell_off_zint-mean2(cell_off_zint(150:250,1:50));
...
cell_off_RI=squeeze(real(temp_rindex(:,:,27)))-n_m;
