...
clear all
close all
path=('I:\soret_paper\RNA\control\control10\');
path_bg=('I:\soret_paper\RNA\control\control10\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=168; ycenter=194; zcenter=27;%control10
% xcenter=168; ycenter=195; zcenter=25;%control11
% xcenter=168; ycenter=193; zcenter=27;%control12
% xcenter=168; ycenter=194; zcenter=27;%control13

%% Set background regions used for normalization (manually defined)
y1=80;y2=180;x1=1;x2=50;%control10
% y1=10;y2=100;x1=100;x2=200;%control11,12
% y1=10;y2=100;x1=250;x2=300;%control13
...
cell_off_zint=cell_off_zint-(mean2(cell_off_zint(107:140,80:121))+mean2(cell_off_zint(144:196,255:303)))/2;%control10
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(74:121,126:211))+mean2(cell_off_zint(285:326,85:153)))/2;%control11
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(74:111,126:211))+mean2(cell_off_zint(301:326,67:153)))/2;%control12
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(240:291,9:32))+mean2(cell_off_zint(269:296,192:207)))/2;%control13
