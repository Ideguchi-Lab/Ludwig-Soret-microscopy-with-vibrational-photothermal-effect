...
clear all
close all
path=('I:\soret_paper\RNA\control\control4\');
path_bg=('I:\soret_paper\RNA\control\control4\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=166; ycenter=191; zcenter=23;%control4
% xcenter=166; ycenter=192; zcenter=25;%control5
% xcenter=166; ycenter=191; zcenter=26;%control6
% xcenter=166; ycenter=191; zcenter=27;%RNA4
% xcenter=166; ycenter=191; zcenter=25;%RNA5
% xcenter=166; ycenter=191; zcenter=29;%RNA6 

%% Set background regions used for normalization (manually defined)
y1=100;y2=200;x1=20;x2=50;%control4, 5
% y1=250;y2=300;x1=200;x2=250;%control6
% y1=100;y2=200;x1=50;x2=100; %RNA4
% y1=50;y2=100;x1=50;x2=150; %RNA5
% y1=50;y2=100;x1=200;x2=250; %RNA6
...
cell_off_zint=cell_off_zint-(mean2(cell_off_zint(128:195,217:269))+mean2(cell_off_zint(113:144,52:79)))/2;%control4
% cell_off_zint=cell_off_zint-mean2(cell_off_zint(134:223,23:49));%control5
% cell_off_zint=cell_off_zint-mean2(cell_off_zint(234:269,113:199));%control6
% cell_off_zint=cell_off_zint-mean2(cell_off_zint(107:133,81:149)); %RNA4
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(89:145,67:95))+mean2(cell_off_zint(211:267,249:273)))/2;%RNA5
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(97:131,197:263))+mean2(cell_off_zint(275:308,115:202)))/2;%RNA6
