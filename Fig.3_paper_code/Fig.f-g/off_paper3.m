...
clear all
close all
path=('I:\soret_paper\RNA\control\control7\');
path_bg=('I:\soret_paper\RNA\control\control7\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=165; ycenter=193; zcenter=26;%control7
% xcenter=166; ycenter=192; zcenter=28;%control8
% xcenter=167; ycenter=193; zcenter=27;%control9
% xcenter=165; ycenter=192; zcenter=26;%RNA7
% xcenter=165; ycenter=192; zcenter=28;%RNA8
% xcenter=167; ycenter=191; zcenter=26;%RNA9

%% Set background regions used for normalization (manually defined)
y1=30;y2=110;x1=280;x2=330;%control7,8
% y1=100;y2=150;x1=300;x2=350;%control9
% y1=100;y2=150;x1=300;x2=350;%RNA7, 8, 9
...
cell_off_zint=cell_off_zint-mean2(cell_off_zint(50:100,290:340));%control7
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(50:100,290:340))+mean2(cell_off_zint(254:306,68:163)))/2;%control8
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(17:52,130:215))+mean2(cell_off_zint(254:306,300:350)))/2;%control9
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(175:245,236:279))+mean2(cell_off_zint(55:108,45:80)))/2;%RNA7
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(71:124,71:124))+mean2(cell_off_zint(189:257,248:297)))/2;%RNA8
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(71:102,71:102))+mean2(cell_off_zint(206:259,238:285)))/2;%RNA9
