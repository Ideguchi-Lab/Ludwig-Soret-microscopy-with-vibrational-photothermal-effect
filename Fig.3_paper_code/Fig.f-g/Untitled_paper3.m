...
%     figure;imagesc(squeeze(real(rindex_stack(ycenter,:,:,30)))-squeeze(real(rindex_stack(ycenter,:,:,6))));daspect([1 7 1]);colorbar;
    ...
    for n=1:num_time
        countnr1_RI(:,:,n)=countnr1_RI(:,:,n)-(mean2(countnr1_RI(250:270,100:200,n))+mean2(countnr1_RI(100:200,40:90,n))+mean2(countnr1_RI(50:100,100:250,n))+mean2(countnr1_RI(100:200,250:300,n)))/4;
        countnr1_zint(:,:,n)=countnr1_zint(:,:,n)-(mean2(countnr1_zint(250:270,100:200,n))+mean2(countnr1_zint(100:200,40:90,n))+mean2(countnr1_zint(50:100,100:250,n))+mean2(countnr1_zint(100:200,250:300,n)))/4;
    end
...
a(6:125)=a(6:125)-a(6);
b=countnr_RI(6);
figure;plot(-a(1:shift+1+num_time-1),'o')

% disp(['Temperature change (K) = ', num2str(b*1e4)])
% disp(['delta_sigma (fg/um^2) = ', num2str(a(125)*0.207*7/0.2*1000)])
disp(['-delta_sigma/ Temperature change (fg/um^2/K) = ', num2str(a(125)/(b*10^4)*0.207*7/0.2*1000)])
