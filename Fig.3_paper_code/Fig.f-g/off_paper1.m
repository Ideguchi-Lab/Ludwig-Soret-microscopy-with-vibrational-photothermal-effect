...
clear all
close all
path=('I:\soret_paper\RNA\control\control1\');
path_bg=('I:\soret_paper\RNA\control\control1\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=167; ycenter=191; zcenter=26;%control1
% xcenter=166; ycenter=192; zcenter=26;%control2
% xcenter=167; ycenter=192; zcenter=29;%control3
% xcenter=165; ycenter=196; zcenter=29;%RNA1
% xcenter=165; ycenter=197; zcenter=29;%RNA2
% xcenter=165; ycenter=195; zcenter=26;%RNA3

%% Set background regions used for normalization (manually defined)
y1=100;y2=200;x1=30;x2=70; %control1
% y1=100;y2=200;x1=30;x2=70; %control2
% y1=100;y2=200;x1=30;x2=65; %control3
% y1=40;y2=80;x1=150;x2=230; %RNA1 
% y1=100;y2=200;x1=50;x2=100;%RNA2 
% y1=50;y2=120;x1=200;x2=280;%RNA3
...
cell_off_zint=cell_off_zint-mean2(cell_off_zint(138:219,46:96));%control1
% cell_off_zint=cell_off_zint-mean2(cell_off_zint(163:235,23:59));%control2, 3
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(188:248,241:275))+mean2(cell_off_zint(192:259,36:67)))/2;%RNA1 
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(150:208,40:86))+mean2(cell_off_zint(82:113,221:276)))/2;%RNA2
% cell_off_zint=cell_off_zint-(mean2(cell_off_zint(150:208,30:66))+mean2(cell_off_zint(100:200,241:289)))/2;%RNA3
