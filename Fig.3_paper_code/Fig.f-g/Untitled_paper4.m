...
countnr_zint(16) = countnr_zint(16)*2;
countnr_RI(16) = countnr_RI(16)*2; % due to different camera exposure compared to other experimental data
figure;plot(-countnr_zint(1:shift+1+num_time-1),'o')
a=countnr_zint(1:shift+1+num_time-1);
a(16:135)=a(16:135)-a(16);%136 time point is invalid value due to above reason
b=countnr_RI(16);
figure;plot(-a(1:shift+1+num_time-1),'o')

% disp(['Temperature change (K) = ', num2str(b*1e4)])
% disp(['delta_sigma (fg/um^2) = ', num2str(a(135)*0.207*7/0.2*1000)])
disp(['-delta_sigma/ Temperature change (fg/um^2/K) = ', num2str(a(135)/(b*10^4)*0.207*7/0.2*1000)])
