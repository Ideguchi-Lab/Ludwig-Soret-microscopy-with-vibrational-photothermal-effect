...
clear all
close all
path=('I:\soret_paper\nuc_cyto\Nuc\COS3_nuc\');
path_bg=('I:\soret_paper\nuc_cyto\Nuc\COS3_nuc\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=168; ycenter=166; zcenter=25;%COS3_nuc
% xcenter=168; ycenter=166; zcenter=24;%COS4_nuc
% xcenter=166; ycenter=168; zcenter=20;%COS4_cyto
% xcenter=168; ycenter=167; zcenter=24;%COS5_cyto
% xcenter=166; ycenter=166; zcenter=26;%COS6_cyto
% xcenter=167; ycenter=168; zcenter=25;%COS7_cyto

%% Set background regions used for normalization (manually defined)
y1=1;y2=100;x1=1;x2=100;%COS3_nuc
% y1=1;y2=50;x1=300;x2=350;%COS4_nuc 
% y1=1;y2=100;x1=1;x2=100;%COS4_cyto
% y1=250;y2=300;x1=250;x2=350;%COS5_cyto
% y1=1;y2=100;x1=1;x2=100;%COS6_cyto
% y1=250;y2=350;x1=300;x2=350;%COS7_cyto
