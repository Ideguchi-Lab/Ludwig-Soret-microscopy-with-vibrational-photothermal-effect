...
clear all
close all
path=('I:\soret_paper\nuc_cyto\Nuc\COS7_nuc\');
path_bg=('I:\soret_paper\nuc_cyto\Nuc\COS7_nuc\bg\');

%% Set the coordinates for the region of interest (center of heating spot in this case)
xcenter=140; ycenter=140; zcenter=30;%COS7_nuc
% xcenter=139; ycenter=141; zcenter=28;%COS8_nuc
% xcenter=138; ycenter=140; zcenter=29;%COS9_nuc
% xcenter=139; ycenter=138; zcenter=29;%COS10_nuc
% xcenter=138; ycenter=140; zcenter=26;%COS11_nuc
% xcenter=138; ycenter=140; zcenter=27;%COS11_cyto 

%% Set background regions used for normalization (manually defined)
y1=100;y2=150;x1=300;x2=350;%COS7_nuc
% y1=1;y2=50;x1=200;x2=300;%COS8_nuc
% y1=200;y2=250;x1=100;x2=150;%COS9_nuc
% y1=250;y2=300;x1=300;x2=350;%COS10_nuc
% y1=1;y2=50;x1=1;x2=100;%COS11_nuc
% y1=1;y2=50;x1=150;x2=250;%COS11_cyto
