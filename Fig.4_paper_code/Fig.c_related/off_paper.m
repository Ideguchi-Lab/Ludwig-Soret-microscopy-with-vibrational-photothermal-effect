...
clear all
close all
path=('I:\soret_paper\nuc_cyto\Nuc\COS2_nuc\');
path_bg=('I:\soret_paper\nuc_cyto\Nuc\COS2_nuc\bg2\');
%% Set background regions used for normalization (manually defined)
y1=150;y2=250;x1=300;x2=350;%COS2_nuc
% y1=150;y2=200;x1=5;x2=50;%COS2_cyto
% y1=150;y2=200;x1=300;x2=350;%COS3_cyto

%% Set background regions used for normalization (manually defined)
xcenter=170; ycenter=168; zcenter=30;%COS2_nuc 
% xcenter=168; ycenter=168; zcenter=30;%COS2_cyto
% xcenter=168; ycenter=168; zcenter=28;%COS3_cyto
